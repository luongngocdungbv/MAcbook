    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="float-right btn btn-<?php echo e($type); ?> <?php echo e(array_get($action_button_attributes, 'class')); ?>" <?php echo Html::attributes(array_except($action_button_attributes, 'class')); ?>><?php echo e($action_name); ?></button>
            </div>
        </div>
    </div>
</div>
