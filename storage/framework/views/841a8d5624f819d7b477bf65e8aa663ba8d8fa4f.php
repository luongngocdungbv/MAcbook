<div class="wrapper-filter">
    ...
    <?php echo e(Form::open(['method' => 'GET', 'class' => 'filter-form'])); ?>
        ...
        <input type="hidden" name="filter_table_id" class="filter-data-table-id" value="<?php echo e($table_id); ?>">
        <input type="hidden" name="class" class="filter-data-class" value="<?php echo e($class); ?>">
        <div class="filter_list inline-block filter-items-wrap">
            <?php $__currentLoopData = $request_filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter_key => $filter_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
