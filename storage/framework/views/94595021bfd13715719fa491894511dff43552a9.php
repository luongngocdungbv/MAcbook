<li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        <li class="external">
            ...
            <a href="<?php echo e(route('contacts.list')); ?>"><?php echo e(trans('plugins.contact::contact.view_all')); ?></a>
        </li>
        <li>
                ...
                <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('contacts.edit', $contact->id)); ?>">
                            <span class="photo">
                                <img src="<?php echo e(url(config('core.acl.general.avatar.default'))); ?>" class="rounded-circle" alt="<?php echo e($contact->name); ?>">
                            </span>
