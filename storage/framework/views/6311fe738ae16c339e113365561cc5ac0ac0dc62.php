...
<head>
    ...
    <link rel="icon shortcut" href="<?php echo e(url(config('core.base.general.favicon'))); ?>">
    <link rel='stylesheet'
...
<body class="<?php echo $__env->yieldContent('body-class', 'page-sidebar-closed-hide-logo page-content-white page-container-bg-solid'); ?>">

    <?php echo $__env->yieldContent('page'); ?>

    <?php echo $__env->make('core.base::elements.common', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
