<?php if(empty($widget_setting) || $widget_setting->status == 1): ?>
    <div class="col-md-6 col-sm-6 col-12 widget_item" id="<?php echo e($widget->name); ?>" data-url="<?php echo e(route('posts.widget.recent-posts')); ?>">
        <div class="portlet light bordered portlet-no-padding">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-settings font-dark"></i>
                    <span class="caption-subject font-dark"><?php echo e(trans('plugins.blog::posts.' . $widget->name)); ?></span>
                </div>
