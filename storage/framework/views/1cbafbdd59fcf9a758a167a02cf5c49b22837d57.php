                ...
                <div class="widget meta-boxes">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseCustomLink">
                        <h4 class="widget-title">
                            <span><?php echo e(trans('core.menu::menu.add_link')); ?></span>
                                ...
                                <div id="external_link" class="the-box">
                                    <div class="node-content">
                                        <div class="form-group">
                                            <label for="node-title"><?php echo e(trans('core.menu::menu.title')); ?></label>
                                            <input type="text" class="form-control" id="node-title" autocomplete="false">
                                        </div>
                                        <div class="form-group">
                                            <label for="node-url"><?php echo e(trans('core.menu::menu.url')); ?></label>
                                            <input type="text" class="form-control" id="node-url" placeholder="http://" autocomplete="false">
                                        </div>
                                        <div class="form-group">
                                            <label for="node-icon"><?php echo e(trans('core.menu::menu.icon')); ?></label>
                                            <input type="text" class="form-control" id="node-icon" placeholder="fa fa-home" autocomplete="false">
                                        </div>
                                        <div class="form-group">
                                            <label for="node-css"><?php echo e(trans('core.menu::menu.css_class')); ?></label>
                                            <input type="text" class="form-control" id="node-css" autocomplete="false">
                                        </div>
                                        <div class="form-group">
                                            <label for="target"><?php echo e(trans('core.menu::menu.target')); ?></label>
                                            <div class="ui-select-wrapper">
                                                <select name="target" class="ui-select" id="target">
                                                    <option value="_self"><?php echo e(trans('core.menu::menu.self_open_link')); ?></option>
                                                    <option value="_blank"><?php echo e(trans('core.menu::menu.blank_open_link')); ?></option>
                                                </select>
                                        ...
                                        <div class="text-right form-group node-actions hidden">
                                            <a class="btn red btn-remove" href="#"><?php echo e(trans('core.menu::menu.remove')); ?></a>
                                            <a class="btn blue btn-cancel" href="#"><?php echo e(trans('core.menu::menu.cancel')); ?></a>
                                        </div>

                                        <div class="form-group">
                                            <div class="text-right add-button">
                                                <div class="btn-group">
                                                    <a href="#" class="btn-add-to-menu btn btn-primary"><span class="text"><i class="fa fa-plus"></i> <?php echo e(trans('core.menu::menu.add_to_menu')); ?></span></a>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="col-md-8">
            <div class="widget meta-boxes">
                <div class="widget-title">
                    <h4>
                        <span><?php echo e(trans('core.menu::menu.structure')); ?></span>
                    </h4>
                </div>
                <div class="widget-body">
