<?php if(empty($widget_setting) || $widget_setting->status == 1): ?>
    <div class="col-md-6 col-sm-6 col-12 widget_item" id="<?php echo e($widget->name); ?>" data-url="<?php echo e(route('analytics.browser')); ?>">
        <div class="portlet light bordered portlet-no-padding">
            ...
            <div class="portlet-body scroll-table equal-height widget-content <?php echo e(array_get(!empty($widget_setting) ? $widget_setting->settings : [], 'state')); ?>"></div>
        </div>
    </div>
<?php endif; ?>