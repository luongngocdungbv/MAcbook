        ...
        <tbody>
            <tr>
                <td class="active-language">
                    <?php echo language_flag($current_language->lang_flag, $current_language->lang_name); ?>
                        ...
                        <select name="language" id="post_lang_choice" class="ui-select">
                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!array_key_exists(json_encode([$language->lang_code]), $related)): ?>
                                    <option value="<?php echo e($language->lang_code); ?>" <?php if($language->lang_code == $current_language->lang_code): ?> selected="selected" <?php endif; ?> data-flag="<?php echo e($language->lang_flag); ?>"><?php echo e($language->lang_name); ?></option>
                                <?php endif; ?>
...
<?php if(count($languages) > 1): ?>
    <div><strong><?php echo e(trans('plugins.language::language.translations')); ?></strong>
        <div id="list-others-language">
            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($language->lang_code != $current_language->lang_code): ?>
                    ...
                    <?php else: ?>
                        ...
                        ?>
                        <a href="<?php echo e(Route::has($route['create']) ? route($route['create']) : '#'); ?>?<?php echo e($query_string); ?>"> <?php echo e($language->lang_name); ?> <i class="fa fa-plus"></i></a>
                        <br>
                    <?php endif; ?>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <input type="hidden" id="lang_meta_content_id" value="<?php echo e($args[0] ? $args[0]->id : ''); ?>">
    <input type="hidden" id="lang_meta_reference" value="<?php echo e($args[1]); ?>">
    <input type="hidden" id="route_create" value="<?php echo e(Route::has($route['create']) ? route($route['create']) : '#'); ?>">
    <input type="hidden" id="route_edit" value="<?php echo e(Route::has($route['edit']) ? route($route['edit'], $args[0] ? $args[0]->id : '') : '#'); ?>">
