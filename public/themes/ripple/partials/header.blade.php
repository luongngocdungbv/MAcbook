...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="shortcut icon" href="{{ url(setting('admin_logo', config('core.base.general.logo'))) }}" type="image/x-icon">
        <!-- Fonts-->
        ...
        <div class="container">
            ...
            <div class="page-header__left" style="text-align: center;">
                <a href="{{ route('public.index') }}" class="page-logo">
                    ...
                    @else
                        <img src="{{ url(theme_option('logo')) }}" alt="{{ setting('site_title') }}" height="145">
                        @if (!theme_option('slogan_logo'))
                        
                        @else
                        <img src="{{ url(theme_option('slogan_logo')) }}" alt="{{ setting('site_title') }}">
                        @endif
                    @endif
                </a>
            </div>
